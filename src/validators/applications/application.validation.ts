...
const getAllApplicationsForJobSchema = z.object({
    ...
    status:z.enum(["PENDING","APPLIED","SHORTLISTED","INTERVIEW","OFFERED","REJECTED", "ACCEPTED", "DECLINED"]).optional(),
...
const updateApplicationSchema = z.object({
    ...
    status:z.enum(["PENDING","APPLIED","SHORTLISTED","INTERVIEW","OFFERED","REJECTED", "ACCEPTED", "DECLINED"]),
});
